    ...
    <div className="min-h-screen bg-[#0B1220] text-slate-100 flex flex-col md:flex-row font-sans">
      ...
      `}>
        ...
        <div className="p-5 border-b border-[#1E2D4A]">
            <div className="text-[10px] uppercase font-semibold tracking-[0.16em] text-slate-400 mb-2">
            Government of India
          </div>
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-[#f4e9e4] border border-[#d9b8ab] flex items-center justify-center text-[#95432d] shrink-0">
        ...
        <div className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          <div className="px-3 py-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-wider flex items-center justify-between">
            ...
            <span className="text-[#95432d] font-mono text-[10px] font-semibold">
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isSelected 
                    ? 'bg-[#f4e9e4] text-[#713722] font-semibold border border-[#d9b8ab]' 
                    : 'text-slate-400 hover:text-slate-200 hover:bg-[#162238]/60 border border-transparent'}
                `}
              >
                <div className="flex items-center gap-3">
                  <Icon className={`w-4 h-4 ${isSelected ? 'text-[#95432d]' : 'text-slate-400'}`} />
                  <div>
                    <span className="block leading-tight">{item.label}</span>
                    <span className="text-[10px] text-slate-400 font-normal">{item.desc}</span>
                  </div>
                </div>
                {isSelected && <span className="w-1.5 h-1.5 rounded-full bg-[#b9573a]"></span>}
              </button>
            );
          })}
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[#0B1220]">
        ...
        {/* TOP HEADER */}
        <header className="border-b border-[#1E2D4A] bg-[#111A2B] px-6 py-4 sticky top-0 z-30">
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto p-5 sm:p-7 lg:p-10">
          {children}
        </main>
